...
const CommentsSection: React.FC<CommentsSectionProps> = ({ recapId, onClose, onCommentCountUpdate, imageContext }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <CommentInput recapId={recapId} onCommentAdded={fetchComments} imageContext={imageContext} />
    </View>
  );
};
